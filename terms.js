 ...
 *
 * Updated 30. Sep 2025 CK
 */

window.hypeLessTerms = [
  // In alphabelical order
  // for verbs, consider two cases: 1st and 3rd person
  // for adjectives, consider adding also corrsponding adverb 
  // for compounds, consider using with and without hypen (e.g., "game-changer")
  ...
  { term: "surprising", explanation: "Subjective reaction; describe results factually instead." },
  ...
  { term: "tremendously", explanation: "Exaggerated hype; avoid overstatement." },
  ...
  { term: "unexpected", explanation: "Subjective reaction; describe results factually instead." },
  ...
  { term: "vastly", explanation: "Exaggerated; specify magnitude with data." },
